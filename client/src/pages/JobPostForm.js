...
const JobPostForm = () => {
  ...
  return (
    <>
      <Container className='customContainer' block style={{borderRadius:'5px'}}>
        <Header as='h3' block style={{ background: '#3f5efb', color: 'white',borderRadius:'5px' }}>Please provide job details: </Header>
