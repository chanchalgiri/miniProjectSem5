...
function SearchResults() {
  ...
  return (
    <Container style={{ margin: 20 }}>
      <Header as='h2' block style={{ background: '#3f5efb', color: 'white'}}>
        Results
      </Header>
      <Card.Group>
        {jobs &&
            ...
            <Card className='customCard' key={job._id} style={{ width: '32%'}} color='blue'>
              <Card.Content>
                ...
                <Card.Description style={{fontSize: '1rem'}}>
                  ...
                  <p><strong>Salary: </strong>Rs.{job.minSalary} to Rs.{job.maxSalary}</p>
              ...
              <Card.Content extra>
                {/* basic color='#B5B2B0' */}
                <Button animated style={{ background: '#3f5efb', color: 'white'}} primary as={Link} to={`/JobPage/${job._id}`}>
